...
class Ui_settings_dialog(object):
    def setupUi(self, settings_dialog):
        ...
        self.last_user = QtGui.QLineEdit(self.groupBox_6)
        self.last_user.setObjectName("last_user")
        self.horizontalLayout_11.addWidget(self.last_user)
        ...
        self.last_pass = QtGui.QLineEdit(self.groupBox_6)
        self.last_pass.setObjectName("last_pass")
        self.horizontalLayout_10.addWidget(self.last_pass)
        ...
        self.last_improve = QtGui.QCheckBox(self.groupBox_7)
        self.last_improve.setObjectName("last_improve")
        self.verticalLayout_10.addWidget(self.last_improve)
        self.last_similar = QtGui.QCheckBox(self.groupBox_7)
        self.last_similar.setObjectName("last_similar")
        self.verticalLayout_10.addWidget(self.last_similar)
    ...
    def retranslateUi(self, settings_dialog):
        ...
        self.groupBox_6.setTitle(QtGui.QApplication.translate("settings_dialog", "last.fm Profile", None, QtGui.QApplication.UnicodeUTF8))
        self.label_10.setText(QtGui.QApplication.translate("settings_dialog", "Username: ", None, QtGui.QApplication.UnicodeUTF8))
        self.label_11.setText(QtGui.QApplication.translate("settings_dialog", "Password: ", None, QtGui.QApplication.UnicodeUTF8))
        self.groupBox_7.setTitle(QtGui.QApplication.translate("settings_dialog", "last.fm Services", None, QtGui.QApplication.UnicodeUTF8))
        self.label_12.setText(QtGui.QApplication.translate("settings_dialog", "Once registered, Amarok can tell the last.fm service about your listening habits; your profile can then provide statistics and recommendations. A profile is not required to retrieve similar-artists for display in the Context Browser.", None, QtGui.QApplication.UnicodeUTF8))
        self.last_improve.setText(QtGui.QApplication.translate("settings_dialog", "Improve my profile by submitting the tracks I play", None, QtGui.QApplication.UnicodeUTF8))
        self.last_similar.setText(QtGui.QApplication.translate("settings_dialog", "Retrieve similar artists", None, QtGui.QApplication.UnicodeUTF8))
